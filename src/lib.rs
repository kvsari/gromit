//! Gromit contains geometric operations, traits and data types.
//!
//! Floats are primarly used for simplicity. But you'll occasionally see `BaseFloat`
//! lurking about due to other math libraries being fancy with their scalar types.
use std::mem;
